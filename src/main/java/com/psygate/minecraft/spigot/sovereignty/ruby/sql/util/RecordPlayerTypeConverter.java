 ...
 */
public class RecordPlayerTypeConverter extends EnumConverter<Integer, RecordPlayerType> {
    public RecordPlayerTypeConverter() {
        super(Integer.class, RecordPlayerType.class);
    }
}
