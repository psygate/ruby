 ...
 */
public class RecordEntityTypeConverter extends EnumConverter<Integer, RecordEntityType> {
    public RecordEntityTypeConverter() {
        super(Integer.class, RecordEntityType.class);
    }
}
