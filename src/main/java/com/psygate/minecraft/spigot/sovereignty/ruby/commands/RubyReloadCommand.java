 ...
 */
public class RubyReloadCommand extends NucleusOPConsoleCommand {
    public RubyReloadCommand() {
        super(0, 0);
    }

    @Override
    protected void subOnCommandOP(CommandSender commandSender, Command command, String s, String[] strings) throws Exception {
        Ruby.getInstance().reloadRuby();
        commandSender.sendMessage(ChatColor.GREEN + "Ruby reloaded.");
    }

    @Override
    protected String[] getName() {
        return new String[]{"rubyreload"};
    }
}
